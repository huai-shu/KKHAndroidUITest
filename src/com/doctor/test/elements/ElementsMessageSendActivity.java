 ...
 *
 */
public class ElementsMessageSendActivity {
	private Solo solo;
	...
	private RelativeLayout title_layoutImageView;
	private TextView more_photoTextView;
	private TextView more_cameraTextView;
	private TextView add_transfer;//[转诊]控件
	private TextView send_gift_or_transfer;//[送苹果]控件

	public ElementsMessageSendActivity(Solo solo){
		this.solo = solo;
		initViews();
	}
	...
	public void initViews() {
		...
		title_layoutImageView = (RelativeLayout) solo.getView("title_layout");//聊天室顶部一栏控件
	}
	 ...
	 * @return
	 */
	public RelativeLayout getTitle_layoutImageView(){
		return title_layoutImageView;
	}
	 ...
	 * 点击[送苹果]控件
	 */
	public void clickSend_gift_or_transfer(){
		send_gift_or_transfer = (TextView) solo.getView("send_gift_or_transfer");
		solo.clickOnView(send_gift_or_transfer);
	}
}
